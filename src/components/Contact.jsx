      ...
      <div className="xl-container contact-grid">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
            {[{ icon: 'mail', text: 'hello@amoni.dev' }, { icon: 'pin_drop', text: 'Remote / Global' }].map(({ icon, text }) => (
        ...
        <form name="contact" method="POST" data-netlify="true" style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
            <label style={{ fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.15em', color: '#dec0ba' }}>Message</label>
